...
Prerequisite: Maven should be installed on your system. download chromedriver file
              Add path of chromedriver.exe in Project\src\main\java\resources\base.java File
...
Go to Project\reports folder to view failure screenshot.
Logs generated in Project\logs Folder.
